		...
		<div class="row">
			<!-- Form -->
				...
				<script>
					...
					// Updates the URL without reloading the page when a pagination link is clicked.
					...
					// Loads the publications based on the current form parameters and calls fetchPublications.
					...
					// Prevents default behavior for the form 
					const form = document.getElementById("publication-form");
